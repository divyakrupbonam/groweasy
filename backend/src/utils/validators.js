...
function normalizeRecord(raw) {
    ...
    // Source rows often have no creation-date column at all (e.g. manual
    // spreadsheets). Rather than importing a lead with a blank created_at,
    // fall back to "now" — the moment it entered GrowEasy CRM.
    if (!record.created_at) {
